        ...
        <main className={"container mx-auto px-4"}>
            <div className={"lg:w-3/5"}>
                ...
                <P>
                    ...
                    <Link href={"https://github.com/SergeyPodgorny"}>Sergey Podgorny</Link>
                    &nbsp;-&nbsp;
                    <Link href={"https://github.com/Friendly-neighborhood-development/Fnd_games_store"}>
                        Games Store
                    </Link>
                </P>
                <div className={"mt-5"}>
                    ...
                    <ul className={"space-y-1"}>
                        <li>
                            <Link href={"http://t.me/keax4208"}>Telegram</Link><br/>
                        </li>
                        <li>
